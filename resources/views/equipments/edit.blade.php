            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('equipments.update', $equipment->id) }}" method="POST">
                    ...
                    @method('PUT') <div class="mb-4">
                        ...
                        <input type="text" name="nama_alat" value="{{ $equipment->nama_alat }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="stok" value="{{ $equipment->stok }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    </div>
